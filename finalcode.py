...
def viewexpense():
    ...
    l=Label(root,text="Date\t  Name\t  Title\t  Expense",font=('arial',15,'bold'),bg="powder blue",fg="black")
...
''')
    ...
    if operation == '+':
        ...
        print('You have not typed a valid operator, You will have to run the program again.')
...
root.title("Expense tracker by Sakshi Patel")

root.geometry('800x600')



dateLabel=Label(root,text="Date",font=('arial',15,'bold'),bg="powder blue",fg="black",width=12)
...
nameLabel=Label(root, text="Name",font=('arial',15,'bold'),bg="powder blue",fg="black",width=12)
...
titleLabel=Label(root, text="Title",font=('arial',15,'bold'),bg="powder blue",fg="black",width=12)
...
expenseLabel=Label(root,text="Expense",font=('arial',15,'bold'),bg="powder blue",fg="black",width=12)
...
calctn=Button(root,command=calculator,text="Calculator",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white",width=12 )
calctn.grid(row=4,column=2,padx=13,pady=13)
